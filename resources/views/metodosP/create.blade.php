...
<head>
  ...
  <title>Creación De Encabezado De Métodos</title>
      ...
      <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1">
          <div class="px-4 sm:px-0">
            <h3 class="font-weight-bold">Creación De Encabezado De Métodos</h3>
            <p class="mt-1 text-sm text-gray-600">
              Agrega el método que representará a los Encabezado De Métodos de indices, ejemplo: 1.1, 1.2, 1.2.3.
            </p>
          </div>
        </div>
            ...
            <div class="shadow overflow-hidden sm:rounded-md">
              ...
              <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                ...
                <a class="btn btn-secundary"
                  onclick="window.location.href='{{ url("metodosP") }}'">Cancelar</a>
              </div>
            </div>
          </form>
        </div>
