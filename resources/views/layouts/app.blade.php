...
<body data-spy="scroll" data-target=".rui-page-sidebar" data-offset="140"
            ...
            <div class="yaybar-wrap">
                <ul>
                    ...
                    @if (\Auth::User()->id_rol == 1)
                        <li class=""><a onclick="window.location='{{ url('/dashboard') }}'"><span
                                    class="yay-icon"><span data-feather="package"
                                        class="rui-icon rui-icon-stroke-1_5"></span></span>
                                <span>Administrador</span> <span class="rui-yaybar-circle"></span></a></li>
                    @endif
                    <li class=""><a onclick="window.location='{{ url('/') }}'"><span
                    ...
                    <li><a data-toggle="tooltip" data-placement="top" title="Metodos"
                            onclick="window.location='{{ url('metodos-list') }}'"><span class="yay-icon"><span
                                    stroke-width="1.5" data-feather="git-branch"></span></span> <span>Métodos</span>
                            <span class="rui-yaybar-circle"></span></a></li>
                    <li><a data-toggle="tooltip" data-placement="top" title="Insumos/Productos"
                            onclick="window.location='{{ url('productos-list') }}'"><span
                                class="yay-icon"><span stroke-width="1.5" data-feather="shuffle"></span></span>
                            <span>Insumos/Productos</span> <span class="rui-yaybar-circle"></span></a></li>
                    <li><a data-toggle="tooltip" data-placement="top" title="Técnicas"
                            onclick="window.location='{{ url('categorias-list') }}'"><span
                                class="yay-icon"><span stroke-width="1.5" data-feather="sidebar"></span></span>
                            ...
                            <li class="ml-10">
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    <a class="text-white" href="{{ route('logout') }}" onclick="event.preventDefault();
                                        ...
                                        <span stroke-width="1.5" data-feather="log-out"></span><span
                                            class="ml-10">{{ __('Cerrar Sesión') }}</span>
                                    </a>
                                </form>
                            </li>
                        @endauth
    ...
    <nav class="rui-navbar rui-navbar-top rui-navbar-sticky border-0">
        <div class="rui-navbar-brand">
            <a href="/" class="rui-navbar-logo"><img src="{{ asset('images/logo-OLS-bl.png') }}"
    ...
    <div class="rui-navbar rui-navbar-mobile">
        <div class="rui-navbar-head"><button class="rui-yaybar-toggle rui-yaybar-toggle-inverse yay-toggle"
            ...
            <a class="rui-navbar-logo" href="/"><img style="margin-left: 31%;"
            ...
            <div class="dropdown dropdown-triangle"><a class="dropdown-item rui-navbar-avatar" href="#"
                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="text-dark"
                        stroke-width="1.5" data-feather="user"></span></a>
