...
<body data-spy="scroll" data-target=".rui-page-sidebar" data-offset="140"
    class="caja rui-no-transition rui-navbar-autohide rui-section-lines">
        ...
        <div class="yay-wrap-menu">
            <div class="yaybar-wrap">
                <ul>
                    ...
                    <li class="yay-item-active"><a onclick="window.location='{{ url('/') }}'"><span
                                class="yay-icon"><span data-feather="home"
                                    class="rui-icon rui-icon-stroke-1_5"></span></span>
                            <span>Clíente</span> <span class="rui-yaybar-circle"></span></a></li>
                    <li class="yay-item-active"><a onclick="window.location='{{ url('dashboard') }}'"><span
                                class="yay-icon"><span data-feather="navigation"
                                    class="rui-icon rui-icon-stroke-1_5"></span></span>
                    ...
                    <li><a data-toggle="tooltip" data-placement="top"
                            title="Listado y creación De Introducciones y logo principal"
                            onclick="window.location='{{ url('principales') }}'"><span class="yay-icon"><span
                                    stroke-width="1.5" data-feather="layout"></span></span>
                            <span>Introducciones y Logo</span> <span class="rui-yaybar-circle"></span></a></li>
                    <li><a data-toggle="tooltip" data-placement="top" title="Listado y creaciónes De usuarios"
                            onclick="window.location='{{ url('users') }}'"><span class="yay-icon"><span
                                    stroke-width="1.5" data-feather="users"></span></span> <span>Usuarios</span> <span
                                class="rui-yaybar-circle"></span></a>
                    </li>
                    <li><a data-toggle="tooltip" data-placement="top" title="Listado y creaciónes De categorías"
                            onclick="window.location='{{ url('categorias') }}'"><span class="yay-icon"><span
                                    stroke-width="1.5" data-feather="clipboard"></span></span> <span>Categoría</span>
                            <span class="rui-yaybar-circle"></span></a></li>
                    <li><a data-toggle="tooltip" data-placement="top"
                            title="Listado y creaciones De metodos - titulo principal"
                            onclick="window.location='{{ url('metodosP') }}'"><span class="yay-icon"><span
                                    stroke-width="1.5" data-feather="git-branch"></span></span> <span>Encabezado
                                Métodos</span> <span class="rui-yaybar-circle"></span></a></li>
                    <li><a data-toggle="tooltip" data-placement="top" title="Listado y creaciones de métodos"
                            onclick="window.location='{{ url('metodos') }}'"><span class="yay-icon"><span
                                    stroke-width="1.5" data-feather="git-merge"></span></span> <span>Métodos</span>
                            <span class="rui-yaybar-circle"></span></a></li>
                    <li><a data-toggle="tooltip" data-placement="top"
                            title="Listado y creaciones De productos e insumos"
                            onclick="window.location='{{ url('productos') }}'"><span class="yay-icon"><span
                                    stroke-width="1.5" data-feather="codesandbox"></span></span>
                            <span>Insumos/Productos</span>
                            <span class="rui-yaybar-circle"></span></a></li>
                    <li><a data-toggle="tooltip" data-placement="top"
                            title="Listado y creaciones De Técnicas - título principal"
                            onclick="window.location='{{ url('tecnicasP') }}'"><span class="yay-icon"><span
                                    stroke-width="1.5" data-feather="trello"></span></span> <span>Encabezado
                                Técnicas</span> <span class="rui-yaybar-circle"></span></a></li>
                    <li><a data-toggle="tooltip" data-placement="top" title="Listado y creaciones De Técnicas"
                            onclick="window.location='{{ url('tecnicas') }}'"><span class="yay-icon"><span
                                    stroke-width="1.5" data-feather="sidebar"></span></span> <span>Técnicas</span> <span
                                class="rui-yaybar-circle"></span></a></li>

                    <li><a data-toggle="tooltip" data-placement="top" title="Listado De productos e insumos x metodos"
                            onclick="window.location='{{ url('insumos_metodos') }}'"><span
                                class="yay-icon"><span stroke-width="1.5"
                                    data-feather="shuffle"></span></span><span>Insumos X Métodos</span> <span
                                class="rui-yaybar-circle"></span></a></li>

                    <li class="yay-label">Opciones De Usuario</li>
                    <li><a data-toggle="tooltip" data-placement="top" title="Cambiar Contraseña"
                            onclick="window.location='{{ route('users.passwordReset', \Auth::user()->id) }}'"><span
                                class="yay-icon"><span stroke-width="1.5" data-feather="users"></span></span>
    ...
    <nav class="rui-navbar rui-navbar-top rui-navbar-sticky border-0">
        <div class="rui-navbar-brand">
            <a href="/dashboard" class="rui-navbar-logo"><img src="{{ asset('images/logo-OLS-bl.png') }}"
                    data-src-night="{{ asset('images/logo-OLS-bl.png') }}"
                    data-src-day="{{ asset('images/logo-OLS-bl.png') }}" alt="" width="200"> </a><span
                style="margin-right: -100px; width:30px; position:relative;"
                class="yay-toggle rui-yaybar-toggle text-white" stroke-width="1.5"
                data-feather="align-justify"></span><span></span></button>
        </div>
    ...
    <div class="rui-navbar rui-navbar-mobile">
        <div class="rui-navbar-head"><button class="rui-yaybar-toggle rui-yaybar-toggle-inverse yay-toggle"
                type="button" aria-label="Toggle side navigation"><span style="margin-right: -20px;"
                    class="yay-toggle rui-yaybar-toggle text-dark" stroke-width="1.5"
                    data-feather="align-justify"></span></button>
            <a class="rui-navbar-logo" href="/dashboard"><img style="margin-left: 31%;"
                    src="{{ asset('images/logo-OLS-bl.png') }}"
                    data-src-night="{{ asset('images/logo-OLS-bl.png') }}"
                    data-src-day="{{ asset('images/logo-OLS-bl.png') }}" alt="" width="180"></a>
            <div class="dropdown dropdown-triangle"><a class="dropdown-item rui-navbar-avatar" href="#"
                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="text-dark"
                        stroke-width="" data-feather="user"></span></a>
